...
class AlumnoController extends Controller
{
	...
	public function actionMiAccion()
	{
		$datos = "Hola, como estas? :D";
		$this->render('miAccion', array('datos'=>$datos));
	}
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Alumno']))
		{
			...
			if($model->save()){
				Yii::app()->db->createCommand('call CREATE_ROL_ALUMNO("'.$model->rut.'")')->execute();
